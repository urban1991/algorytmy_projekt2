    ...
    <Box mb={4}>
      ...
      >
        ...
        <Typography variant="h6">
          W czasach Sherloka Holmesa w epoce Królowej Wiktorii Anglia miała
          skomplikowany system monetarny:
          <br />
          ...
          który dowolną sumę wyrażoną w pensach wyda korzystając z najmniejszej
          ilości jednostek monetarnych (uwzględniając półpensówki i ćwiartki).
        </Typography>
      </Paper>
    </Box>
  );
